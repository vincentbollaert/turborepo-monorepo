...
### 11.1.4 TypeScript Build Performance
...
### 11.2.3 Code Splitting Strategies
...
### 11.2.5 Bundle Budget Enforcement
...
## 11.3 Runtime Performance (Core Web Vitals)

**TARGET: Pass all Core Web Vitals thresholds**

### 11.3.1 Core Web Vitals Targets
...
### 11.3.2 Additional Performance Metrics
...
## 11.4 React Performance Patterns

**RECOMMENDED: Use performance optimizations strategically**

### 11.4.1 When to Use React.memo
...
### 11.4.3 When to Use useCallback
...
### 11.4.5 Lazy Loading Components
...
### 11.4.6 Debouncing and Throttling
...
### 11.5.1 Real User Monitoring (RUM)
...
### 11.5.2 Performance Budgets in CI
...
### 11.6.4 Next.js Image Component
