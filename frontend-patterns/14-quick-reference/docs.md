...
> **Quick Guide:** Essential patterns, critical do's and don'ts, and file-scoped commands for fast feedback. This is a condensed reference of all 13 previous sections.

## 14.1 Essential Code Patterns
...
For deep dives, see these sections:

- **Package Architecture** → [Section 01](../01-package-architecture/docs.md)
- **API Client** → [Section 02](../02-api-client-architecture/docs.md)
- **Code Conventions** → [Section 03](../03-code-conventions/docs.md)
- **State Management** → [Section 04](../04-state-management/docs.md)
- **Testing Standards** → [Section 05](../05-testing-standards/docs.md)
- **Design System** → [Section 06](../06-design-system/docs.md)
- **Accessibility** → [Section 07](../07-accessibility/docs.md)
- **Build & Tooling** → [Section 08](../08-build-tooling/docs.md)
- **CI/CD** → [Section 09](../09-ci-cd-pipelines/docs.md)
- **Environment Management** → [Section 10](../10-environment-management/docs.md)
- **Performance** → [Section 11](../11-performance-standards/docs.md)
- **Security** → [Section 12](../12-security-patterns/docs.md)
- **Anti-Patterns** → [Section 13](../13-anti-patterns/docs.md)
