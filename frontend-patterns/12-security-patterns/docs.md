...
> **Quick Guide:** Managing secrets? See §12.1 (never commit). Dependency security? See §12.2 (Dependabot). XSS prevention? See §12.3. CODEOWNERS? See §12.4.

**Cross-references:**
- Environment variable security: See [Environment Management §10.5](../10-environment-management/docs.md#105-security-best-practices)
- CI/CD security: See [CI/CD Pipelines §9.6](../09-ci-cd-pipelines/docs.md#96-security-and-secrets)

## 12.1 Secret Management

**CRITICAL: Never commit secrets to repository**

### 12.1.1 What Are Secrets
...
> See [Environment Management §10.5](../10-environment-management/docs.md#105-security-best-practices)

## 12.2 Dependency Security

**RECOMMENDED: Automated vulnerability scanning**

### 12.2.1 Vulnerability Scanning
...
### 12.2.3 Automated Security Checks
...
> See [CI/CD Pipelines §9.6.2](../09-ci-cd-pipelines/docs.md#962-dependency-security)

## 12.3 XSS Prevention

**CRITICAL: Prevent Cross-Site Scripting attacks**

### 12.3.1 React's Built-in Protection
...
### 12.3.3 Content Security Policy
...
## 12.4 Code Ownership (CODEOWNERS)
...
## 12.6 Common Security Anti-Patterns
