...
> **Quick Guide:** Building components? See §3.1. TypeScript setup? See §3.6. Need constants? See §3.5 (no magic numbers!). Icons? See §3.13 (lucide-react). Error handling? See §3.7.
...
> See [examples.md](./examples.md#311-component-state-styling) for code examples
...
## 3.12 Component Documentation (Ladle Stories)
...
> See [examples.md](./examples.md#312-component-documentation) for code examples
...
> See [examples.md](./examples.md#313-icon-library) for code examples
