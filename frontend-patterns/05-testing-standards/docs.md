...
> See [examples.md](./examples.md#52-e2e-testing) for Playwright examples
...
## 5.3 Unit Testing (Pure Functions Only)
...
> See [examples.md](./examples.md#53-unit-testing) for more examples
...
## 5.4 Integration Testing (Current Approach)
...
> See [examples.md](./examples.md#54-integration-testing) for current codebase examples
...
## 5.5 Test Organization (Feature-Based Structure)

**MANDATORY: Follow feature-based folder pattern from [01-package-architecture](../01-package-architecture/docs.md)**
...
## 5.6 Mock Data Patterns (Current Approach)
...
> See [examples.md](./examples.md#56-mock-data-patterns) for current patterns
