...
> See [examples.md - Pipeline Configuration](./examples.md#91-pipeline-configuration) for implementation
...
### 9.2.2 PR vs Main Branch Strategy
...
### 9.2.4 Affected Build Optimization
...
> See [examples.md - Affected Detection](./examples.md#92-affected-detection) for implementation
...
> See [examples.md - Remote Caching](./examples.md#93-remote-caching) for implementation

## 9.4 Quality Gates

**MANDATORY: Automated checks before merge**

### 9.4.1 Required Checks
...
### 9.4.4 Automated vs Manual Gates
...
> See [examples.md - Quality Gates](./examples.md#94-quality-gates) for implementation

## 9.5 Deployment Workflows

**RECOMMENDED: Automatic deployment from main, manual approval for production**

### 9.5.1 Branch Deployment Strategy
...
> See [examples.md - Deployment Workflows](./examples.md#95-deployment-workflows) for implementation

## 9.6 Security and Secrets

**CRITICAL: Never commit secrets**

### 9.6.1 Secret Management
...
> See [examples.md - Performance Optimization](./examples.md#97-performance-optimization) for implementation
