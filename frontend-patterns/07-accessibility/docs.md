...
> See [examples.md - Keyboard Navigation Standards](./examples.md#71-keyboard-navigation-standards) for implementation

## 7.2 ARIA Patterns

**BEST PRACTICE: Use Radix UI components for built-in accessibility**

### 7.2.1 Component-Specific ARIA
...
> See [examples.md - ARIA Patterns](./examples.md#72-aria-patterns) for implementation

## 7.3 Color Contrast Requirements

**TARGET: WCAG AA minimum (4.5:1 for text, 3:1 for UI components)**

### 7.3.1 Contrast Ratios
...
> See [examples.md - Color Contrast Requirements](./examples.md#73-color-contrast-requirements) for implementation
...
> See [examples.md - Form Accessibility](./examples.md#75-form-accessibility) for implementation
...
### 7.8.2 Hidden from Screen Readers
...
### 7.9.2 Manual Testing Checklist
...
> See [examples.md - Testing Approach](./examples.md#79-testing-approach) for implementation

## 7.10 Common Anti-Patterns
