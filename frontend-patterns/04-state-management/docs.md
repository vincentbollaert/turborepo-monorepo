...
> **Quick Guide:** Server data? React Query (§4.2). Local UI? useState (§4.3.1). Shared UI? Zustand (§4.3.2). Singleton/DI? Context (§4.4). **NEVER use Context for state management!**
...
## 4.2 React Query Patterns (OpenAPI-Generated)
...
> See [examples.md](./examples.md#42-react-query-patterns) for complete examples
...
## 4.3 Client State Management (Local vs Global)
...
> See [examples.md](./examples.md#43-client-state-management) for complete examples
...
## 4.4 Context API - NOT for State Management
...
> See [examples.md](./examples.md#44-context-api-not-for-state) for examples

## 4.5 URL State for Shareable Filters
...
> See [examples.md](./examples.md#45-url-state) for complete examples
