...
### 10.1.3 Loading Order and Precedence
...
### 10.1.4 Per-App vs Root Environment Files
...
> See [examples.md - File Hierarchy](./examples.md#101-file-hierarchy) for implementation

## 10.2 Naming Conventions

**ACTUAL IMPLEMENTATION: Framework-specific prefixes**

### 10.2.1 Variable Naming Rules
...
### 10.2.2 Framework-Specific Prefixes
...
> See [examples.md - Naming Conventions](./examples.md#102-naming-conventions) for implementation

## 10.3 Type-Safe Environment Variables

**ACTUAL IMPLEMENTATION: Zod validation (apps/client-next/app/env.ts)**

### 10.3.1 Validation Pattern
...
> See [examples.md - Type-Safe Environment Variables](./examples.md#103-type-safe-environment-variables) for implementation

## 10.4 Environment File Templates

**RECOMMENDED: Maintain `.env.example` for documentation**

### 10.4.1 Template Structure
...
> See [examples.md - Environment File Templates](./examples.md#104-environment-file-templates) for implementation

## 10.5 Security Best Practices

**CRITICAL: Never commit secrets to repository**

### 10.5.1 Secret Management
...
### 10.5.2 .gitignore Configuration
...
### 10.5.3 CI/CD Secret Management
...
### 10.5.5 Turbo Environment Variable Validation
...
> See [examples.md - Security Best Practices](./examples.md#105-security-best-practices) for implementation

## 10.6 Feature Flags

**RECOMMENDED: Environment-based feature flags**

### 10.6.1 Simple Feature Flags
...
> See [examples.md - Feature Flags](./examples.md#106-feature-flags) for implementation

## 10.7 Configuration by Environment

**RECOMMENDED: Environment-specific configuration object**

### 10.7.1 Configuration Pattern
...
### 10.7.2 Configuration Categories
...
> See [examples.md - Configuration by Environment](./examples.md#107-configuration-by-environment) for implementation

## 10.8 Common Anti-Patterns
